export const environment = {
  ...
  social: {
    ...
    website: 'https://elishconsulting.com',
  ...
  helptext: {
    login: "CRM Cloud App provide three different methods to sign in.  You can use existing Google/Facebook login or using your email with any password. app password is NOT same as your email password.   Please send email to contact@elishconsulting.com for any support.",
